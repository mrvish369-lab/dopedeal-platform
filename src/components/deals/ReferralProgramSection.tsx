      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-gradient-to-br from-brand-forest to-brand-forest-mid rounded-3xl p-8 text-white">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-2xl bg-brand-green/20 flex items-center justify-center">
                <Users className="w-6 h-6 text-brand-green-light" />
              </div>
              <div>
                <div className="text-xs text-brand-green-light/70 font-mono uppercase tracking-wider">
                  Your Referral Code
                </div>
                <div className="font-display font-black text-2xl">{referralCode}</div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={handleCopy}
                  className="shrink-0 p-2 rounded-xl bg-brand-green hover:bg-brand-green-light transition-colors"
                >
                  {copied ? (
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <button
                ...
                className="bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold text-sm py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="bg-[#0088cc] hover:bg-[#006699] text-white font-semibold text-sm py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
              >
                <Share2 className="w-4 h-4" />
                Telegram
              </button>
            ...
            {user && (
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center">
                  <div className="font-display font-black text-xl text-brand-green-light">0</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center">
                  <div className="font-display font-black text-xl text-brand-green-light">10%</div>
          ...
          <div className="space-y-4">
            <div className="bg-brand-surface2 border border-brand-border rounded-2xl p-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-green to-brand-green-dim flex items-center justify-center text-white font-bold shrink-0">
                  1
                </div>
                <div>
        ...
        <div className="bg-gradient-to-br from-brand-green/10 to-brand-teal/10 border-2 border-brand-green/30 rounded-3xl p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-green to-brand-green-dim flex items-center justify-center shrink-0">
                <TrendingUp className="w-7 h-7 text-white" />
              </div>
              <div>
                <h3 className="font-display font-black text-xl text-brand-forest mb-2">
                  Earning Potential Example
                </h3>
                <div className="space-y-1 text-sm text-brand-text-dim">
            ...
            <Link
              ...
              className="shrink-0 bg-gradient-to-r from-brand-green to-brand-green-dim text-white font-bold text-sm px-6 py-3 rounded-2xl hover:shadow-lg hover:shadow-brand-green/30 transition-all flex items-center gap-2"
            >
